...
namespace DashiToon.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240926102619_Add Series Entity")]
    partial class AddSeriesEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.TodoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.TodoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.Chapter", b =>
                {
                    b.HasOne("DashiToon.Api.Domain.Entities.Volume", null)
                        .WithMany("Chapters")
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("DashiToon.Api.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("DashiToon.Api.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
