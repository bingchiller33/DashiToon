...
namespace DashiToon.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241126092205_User User Remove UsernameUpdated")]
    partial class UserUserRemoveUsernameUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DashiToon.Api.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RestrictPublishUntil")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.Report", b =>
                {
                    ...
                    b.HasOne("DashiToon.Api.Domain.Entities.Comment", "Comment")
                        .WithMany()
                        .HasForeignKey("CommentId");
                    ...
                    b.HasOne("DashiToon.Api.Domain.Entities.Review", "Review")
                        .WithMany()
                    ...
                    b.OwnsOne("DashiToon.Api.Domain.Entities.ModerationAnalysis", "Analysis", b1 =>
                        {
                            ...
                            b1.Property<string>("FlaggedCategories")
                                .IsRequired()
                                .HasColumnType("text");
            ...
            modelBuilder.Entity("DashiToon.Api.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.OwnsMany("DashiToon.Api.Domain.Entities.SubscriptionHistory", "Histories", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("SubscriptionHistory");
            ...
            modelBuilder.Entity("DashiToon.Api.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.OwnsMany("DashiToon.Api.Domain.Entities.RevenueTransaction", "RevenueTransactions", b1 =>
                        {
                            ...
                            b1.ToTable("RevenueTransaction");

                            b1.WithOwner()
                                .HasForeignKey("AuthorId");

                            b1.HasOne("DashiToon.Api.Domain.Entities.Series", "Series")
                                .WithMany()
                                .HasForeignKey("SeriesId");
                    ...
                    b.OwnsMany("DashiToon.Api.Domain.Entities.KanaTransaction", "Ledgers", b1 =>
                        {
                            ...
                            b1.HasOne("DashiToon.Api.Domain.Entities.Chapter", "Chapter")
                                .WithMany()
                                .HasForeignKey("ChapterId");
                    ...
                    b.Navigation("RevenueTransactions");
                });
