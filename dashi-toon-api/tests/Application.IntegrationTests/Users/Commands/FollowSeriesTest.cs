...
public class FollowSeriesTest : BaseIntegrationTest
{
    public FollowSeriesTest(Testing testing) : base(testing)
    {
        ResetState().Wait();
    }

    [Fact]
    public async Task FollowSeriesShouldSucceed()
    {
        // Arrange
    ...
    [Fact]
    public async Task FollowSeriesShouldRequirePublishedSeries()
    {
        // Arrange
        await RunAsDefaultUserAsync();
        ...
        // Act & Assert
        await FluentActions.Invoking(() => SendAsync(new FollowSeriesCommand(seriesId)))
            .Should().ThrowAsync<NotFoundException>();
    }

    [Fact]
    public async Task FollowSeriesShouldNotAllowedDuplicateFollow()
    {
        // Arrange
        await RunAsDefaultUserAsync();
        ...
        // Act & Assert
        await FluentActions.Invoking(() => SendAsync(new FollowSeriesCommand(seriesId)))
            .Should().ThrowAsync<AlreadyFollowedException>();
    }
}
